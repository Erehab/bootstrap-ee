// Examples and docs at: https://mottie.github.io/tablesorter/docs/

$(function() {

    if (typeof pre_tablesorter == 'function') {
      pre_tablesorter();
  }
...
$grid_tablesorter=$("#grid").tablesorter({
...
.bind('filterEnd', function() {
  $("#countGridRow").html("");
  var rowcount=($('#grid tr:visible').length)-2;
  $("#countGridRow").html("Filtered: " + rowcount);
});
...
if (typeof post_tablesorter == 'function') {
  post_tablesorter();
}
