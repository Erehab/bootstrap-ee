...
ts.addWidget({
	...
	options : {
		...
		// use this format: "https://mydatabase.com?page={page}&size={size}&{sortList:col}&{filterList:fcol}"
	...
	updatePageDisplay: function(table, c, completed) {
		...
		if ( Math.min( p.totalPages, p.filteredPages ) >= 0 ) {
			...
			if ( p.$goto.length ) {
				...
				// innerHTML doesn't work in IE9 - https://support2.microsoft.com/kb/276228
